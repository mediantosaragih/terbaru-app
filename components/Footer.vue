...
<footer class="text-center text-lg-start bg-light text-muted">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>Office
          </h6>
          <p>Komplek CBD Polonia, Blok DD No.68-69, Kota Medan, Sumatera Utara 20157</p>
        </div>
        <!-- Grid column -->
  ...
  <!-- Copyright -->
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">PT.Literasia Edutekno Digital © 2018 - 2022
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
